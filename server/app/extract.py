...
SYSTEM_MOD = (
    ...
    "and most SF-30s never state one. Fill it ONLY from a figure the document "
    "presents as a running total — the '$Y' of 'increased from $X to $Y', or a "
    "phrase like 'total obligated amount of this contract to date'. A line reading "
